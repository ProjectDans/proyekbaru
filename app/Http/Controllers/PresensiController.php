...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($presensi){
            return redirect('presensimasuk')->with('success', 'Anda sudah melakukan presensi masuk!');
        }else{
            Presensi::create([
                'user_id' => auth()->user()->id,
                'tgl' => $tanggal,
    ...
    public function presensipulang(){
        ...
        if ($presensi->jamkeluar == ""){
            $presensi->update($dt);
            return redirect('presensikeluar');
        }else{
            return redirect('presensikeluar')->with('success', 'Anda Sudah Melakukan Presensi Pulang!');
        }
    }
